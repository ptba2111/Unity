...
# Uncomment DIRSEPOL if you want sepolicy patches applied to the boot img directly (not recommended) - note that this will not survive an OTA or dirty flash
#                    THIS REQUIRES THE RAMDISK PATCHER ADDON (this addon requires minimum api of 17)
